...
__attribute__((swift_name("CameraConfig")))
@interface TruliooCoreCameraConfig : TruliooCoreBase
- (instancetype)initWithCameraId:(NSString *)cameraId detectionType:(TruliooCoreDetectionType *)detectionType __attribute__((swift_name("init(cameraId:detectionType:)"))) __attribute__((objc_designated_initializer));
- (TruliooCoreCameraConfig *)doCopyCameraId:(NSString *)cameraId detectionType:(TruliooCoreDetectionType *)detectionType __attribute__((swift_name("doCopy(cameraId:detectionType:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *cameraId __attribute__((swift_name("cameraId")));
@property TruliooCoreDetectionType *detectionType __attribute__((swift_name("detectionType")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CameraProps")))
@interface TruliooCoreCameraProps : TruliooCoreBase
- (instancetype)initWithCameraId:(NSString *)cameraId backgroundColor:(NSString *)backgroundColor __attribute__((swift_name("init(cameraId:backgroundColor:)"))) __attribute__((objc_designated_initializer));
- (TruliooCoreCameraProps *)doCopyCameraId:(NSString *)cameraId backgroundColor:(NSString *)backgroundColor __attribute__((swift_name("doCopy(cameraId:backgroundColor:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (BOOL)shouldShowAnimation __attribute__((swift_name("shouldShowAnimation()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface TruliooCoreCaptureMode : TruliooCoreKotlinEnum<TruliooCoreCaptureMode *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) TruliooCoreCaptureMode *auto_ __attribute__((swift_name("auto_")));
@property (class, readonly) TruliooCoreCaptureMode *manual __attribute__((swift_name("manual")));
+ (TruliooCoreKotlinArray<TruliooCoreCaptureMode *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreCaptureMode *> *entries __attribute__((swift_name("entries")));
@end
...
@interface TruliooCoreCoordinates : TruliooCoreBase
- (instancetype)initWithTopLeft:(TruliooCoreScreenPoint *)topLeft bottomRight:(TruliooCoreScreenPoint *)bottomRight center:(TruliooCoreScreenPoint *)center selfieRadius:(float)selfieRadius __attribute__((swift_name("init(topLeft:bottomRight:center:selfieRadius:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) TruliooCoreCoordinatesCompanion *companion __attribute__((swift_name("companion")));
- (TruliooCoreCoordinates *)doCopyTopLeft:(TruliooCoreScreenPoint *)topLeft bottomRight:(TruliooCoreScreenPoint *)bottomRight center:(TruliooCoreScreenPoint *)center selfieRadius:(float)selfieRadius __attribute__((swift_name("doCopy(topLeft:bottomRight:center:selfieRadius:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)toJsonString __attribute__((swift_name("toJsonString()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) TruliooCoreScreenPoint *bottomRight __attribute__((swift_name("bottomRight")));
@property (readonly) TruliooCoreScreenPoint *center __attribute__((swift_name("center")));
@property (readonly) float selfieRadius __attribute__((swift_name("selfieRadius")));
@property (readonly) TruliooCoreScreenPoint *topLeft __attribute__((swift_name("topLeft")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Coordinates.Companion")))
@interface TruliooCoreCoordinatesCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreCoordinatesCompanion *shared __attribute__((swift_name("shared")));
- (id<TruliooCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DetectionType")))
@interface TruliooCoreDetectionType : TruliooCoreKotlinEnum<TruliooCoreDetectionType *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) TruliooCoreDetectionTypeCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) TruliooCoreDetectionType *document __attribute__((swift_name("document")));
@property (class, readonly) TruliooCoreDetectionType *passport __attribute__((swift_name("passport")));
@property (class, readonly) TruliooCoreDetectionType *biometricSelfie __attribute__((swift_name("biometricSelfie")));
@property (class, readonly) TruliooCoreDetectionType *noDetection __attribute__((swift_name("noDetection")));
+ (TruliooCoreKotlinArray<TruliooCoreDetectionType *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreDetectionType *> *entries __attribute__((swift_name("entries")));
- (TruliooCoreAPIContractStepType *)getStepTypeConfigDetectionType:(TruliooCoreDetectionType *)configDetectionType __attribute__((swift_name("getStepType(configDetectionType:)")));
- (TruliooCoreDocumentType *)mapToDocumentType __attribute__((swift_name("mapToDocumentType()")));
- (float)viewFinderRatioForCapture __attribute__((swift_name("viewFinderRatioForCapture()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DetectionType.Companion")))
@interface TruliooCoreDetectionTypeCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreDetectionTypeCompanion *shared __attribute__((swift_name("shared")));
- (TruliooCoreDetectionType *)fromIntIntValue:(int32_t)intValue __attribute__((swift_name("fromInt(intValue:)")));
- (TruliooCoreDetectionType *)mapToDetectionTypeDocumentDetected:(id<TruliooCoreIDetectionType>)documentDetected __attribute__((swift_name("mapToDetectionType(documentDetected:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeedbackState")))
@interface TruliooCoreFeedbackState : TruliooCoreKotlinEnum<TruliooCoreFeedbackState *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) TruliooCoreFeedbackState *none __attribute__((swift_name("none")));
@property (class, readonly) TruliooCoreFeedbackState *capturing __attribute__((swift_name("capturing")));
@property (class, readonly) TruliooCoreFeedbackState *blur __attribute__((swift_name("blur")));
@property (class, readonly) TruliooCoreFeedbackState *success __attribute__((swift_name("success")));
@property (class, readonly) TruliooCoreFeedbackState *error __attribute__((swift_name("error")));
@property (class, readonly) TruliooCoreFeedbackState *tooClose __attribute__((swift_name("tooClose")));
@property (class, readonly) TruliooCoreFeedbackState *tooFar __attribute__((swift_name("tooFar")));
+ (TruliooCoreKotlinArray<TruliooCoreFeedbackState *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreFeedbackState *> *entries __attribute__((swift_name("entries")));
@end

__attribute__((swift_name("ITruliooFeedbackStateFlow")))
@interface TruliooCoreITruliooFeedbackStateFlow : TruliooCoreBase
...
*/
- (void)collectEventsCollector:(id<TruliooCoreKotlinSuspendFunction1>)collector completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("collectEvents(collector:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)sendEventEvent:(TruliooCoreFeedbackState *)event completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("sendEvent(event:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeedbackStateFlow")))
@interface TruliooCoreFeedbackStateFlow : TruliooCoreITruliooFeedbackStateFlow
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@end

__attribute__((swift_name("ITruliooImageFeedbackFlow")))
@interface TruliooCoreITruliooImageFeedbackFlow : TruliooCoreBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)sendEventEvent:(TruliooCoreTruliooImageFeedback *)event completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("sendEvent(event:completionHandler:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ScreenPoint")))
@interface TruliooCoreScreenPoint : TruliooCoreBase
- (instancetype)initWithX:(float)x y:(float)y __attribute__((swift_name("init(x:y:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) TruliooCoreScreenPointCompanion *companion __attribute__((swift_name("companion")));
- (TruliooCoreScreenPoint *)doCopyX:(float)x y:(float)y __attribute__((swift_name("doCopy(x:y:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ScreenPoint.Companion")))
@interface TruliooCoreScreenPointCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreScreenPointCompanion *shared __attribute__((swift_name("shared")));
- (id<TruliooCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TruliooImageFeedback")))
@interface TruliooCoreTruliooImageFeedback : TruliooCoreBase
- (instancetype)initWithImageId:(NSString *)imageId hasAcceptableQuality:(BOOL)hasAcceptableQuality hasBlur:(BOOL)hasBlur hasGlare:(BOOL)hasGlare hasDetection:(BOOL)hasDetection detectionType:(TruliooCoreDetectionType * _Nullable)detectionType requiresBackCapture:(BOOL)requiresBackCapture tooClose:(BOOL)tooClose tooFar:(BOOL)tooFar __attribute__((swift_name("init(imageId:hasAcceptableQuality:hasBlur:hasGlare:hasDetection:detectionType:requiresBackCapture:tooClose:tooFar:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) TruliooCoreTruliooImageFeedbackCompanion *companion __attribute__((swift_name("companion")));
- (TruliooCoreTruliooImageFeedback *)doCopyImageId:(NSString *)imageId hasAcceptableQuality:(BOOL)hasAcceptableQuality hasBlur:(BOOL)hasBlur hasGlare:(BOOL)hasGlare hasDetection:(BOOL)hasDetection detectionType:(TruliooCoreDetectionType * _Nullable)detectionType requiresBackCapture:(BOOL)requiresBackCapture tooClose:(BOOL)tooClose tooFar:(BOOL)tooFar __attribute__((swift_name("doCopy(imageId:hasAcceptableQuality:hasBlur:hasGlare:hasDetection:detectionType:requiresBackCapture:tooClose:tooFar:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (TruliooCoreAPIContractStepType *)getApiStepTypeIsSelfie:(BOOL)isSelfie __attribute__((swift_name("getApiStepType(isSelfie:)")));
- (TruliooCoreSessionImageType *)getSessionImageTypeIsSelfie:(BOOL)isSelfie __attribute__((swift_name("getSessionImageType(isSelfie:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)toJsonString __attribute__((swift_name("toJsonString()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) TruliooCoreDetectionType * _Nullable detectionType __attribute__((swift_name("detectionType")));
@property BOOL hasAcceptableQuality __attribute__((swift_name("hasAcceptableQuality")));
@property BOOL hasBlur __attribute__((swift_name("hasBlur")));
@property BOOL hasDetection __attribute__((swift_name("hasDetection")));
@property BOOL hasGlare __attribute__((swift_name("hasGlare")));
@property (readonly) NSString *imageId __attribute__((swift_name("imageId")));
@property (readonly) BOOL requiresBackCapture __attribute__((swift_name("requiresBackCapture")));
@property (readonly) BOOL tooClose __attribute__((swift_name("tooClose")));
@property (readonly) BOOL tooFar __attribute__((swift_name("tooFar")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TruliooImageFeedback.Companion")))
@interface TruliooCoreTruliooImageFeedbackCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreTruliooImageFeedbackCompanion *shared __attribute__((swift_name("shared")));
- (id<TruliooCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TruliooImageFeedbackFlow")))
@interface TruliooCoreTruliooImageFeedbackFlow : TruliooCoreITruliooImageFeedbackFlow
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TruliooImageVerifyResponse")))
@interface TruliooCoreTruliooImageVerifyResponse : TruliooCoreBase
- (instancetype)initWithImageId:(NSString *)imageId classifiedDocument:(BOOL)classifiedDocument isSupportedDocument:(BOOL)isSupportedDocument isExpiredDocument:(BOOL)isExpiredDocument imageIds:(NSArray<NSString *> * _Nullable)imageIds __attribute__((swift_name("init(imageId:classifiedDocument:isSupportedDocument:isExpiredDocument:imageIds:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) TruliooCoreTruliooImageVerifyResponseCompanion *companion __attribute__((swift_name("companion")));
- (TruliooCoreTruliooImageVerifyResponse *)doCopyImageId:(NSString *)imageId classifiedDocument:(BOOL)classifiedDocument isSupportedDocument:(BOOL)isSupportedDocument isExpiredDocument:(BOOL)isExpiredDocument imageIds:(NSArray<NSString *> * _Nullable)imageIds __attribute__((swift_name("doCopy(imageId:classifiedDocument:isSupportedDocument:isExpiredDocument:imageIds:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)toJsonString __attribute__((swift_name("toJsonString()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property BOOL classifiedDocument __attribute__((swift_name("classifiedDocument")));
@property (readonly) NSString *imageId __attribute__((swift_name("imageId")));
@property NSArray<NSString *> * _Nullable imageIds __attribute__((swift_name("imageIds")));
@property BOOL isExpiredDocument __attribute__((swift_name("isExpiredDocument")));
@property BOOL isSupportedDocument __attribute__((swift_name("isSupportedDocument")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TruliooImageVerifyResponse.Companion")))
@interface TruliooCoreTruliooImageVerifyResponseCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreTruliooImageVerifyResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<TruliooCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TruliooVerifyResponse")))
@interface TruliooCoreTruliooVerifyResponse : TruliooCoreBase
- (instancetype)initWithIsVerifyAttemptAvailable:(TruliooCoreBoolean * _Nullable)isVerifyAttemptAvailable verificationStatus:(TruliooCoreVerificationStatus *)verificationStatus requiresBackCapture:(BOOL)requiresBackCapture __attribute__((swift_name("init(isVerifyAttemptAvailable:verificationStatus:requiresBackCapture:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) TruliooCoreTruliooVerifyResponseCompanion *companion __attribute__((swift_name("companion")));
- (TruliooCoreTruliooVerifyResponse *)doCopyIsVerifyAttemptAvailable:(TruliooCoreBoolean * _Nullable)isVerifyAttemptAvailable verificationStatus:(TruliooCoreVerificationStatus *)verificationStatus requiresBackCapture:(BOOL)requiresBackCapture __attribute__((swift_name("doCopy(isVerifyAttemptAvailable:verificationStatus:requiresBackCapture:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)toJsonString __attribute__((swift_name("toJsonString()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) TruliooCoreBoolean * _Nullable isVerifyAttemptAvailable __attribute__((swift_name("isVerifyAttemptAvailable")));
@property (readonly) BOOL requiresBackCapture __attribute__((swift_name("requiresBackCapture")));
@property (readonly) TruliooCoreVerificationStatus *verificationStatus __attribute__((swift_name("verificationStatus")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TruliooVerifyResponse.Companion")))
@interface TruliooCoreTruliooVerifyResponseCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreTruliooVerifyResponseCompanion *shared __attribute__((swift_name("shared")));
- (TruliooCoreTruliooVerifyResponse *)fromACImageFeedbackFeedbackAC:(TruliooCoreTruliooImageFeedback *)feedbackAC retryAvailable:(TruliooCoreBoolean * _Nullable)retryAvailable __attribute__((swift_name("fromACImageFeedback(feedbackAC:retryAvailable:)")));
- (TruliooCoreVerificationStatus *)getStatusForFinalRetryVerificationStatus:(TruliooCoreVerificationStatus *)verificationStatus __attribute__((swift_name("getStatusForFinalRetry(verificationStatus:)")));
- (TruliooCoreVerificationStatus *)mapStatusFromACFeedbackFeedbackAC:(TruliooCoreTruliooImageFeedback *)feedbackAC __attribute__((swift_name("mapStatusFromACFeedback(feedbackAC:)")));
- (TruliooCoreVerificationStatus *)mapStatusFromResponseRes:(TruliooCoreDocumentVerifyResponse * _Nullable)res __attribute__((swift_name("mapStatusFromResponse(res:)")));
- (id<TruliooCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("VerificationStatus")))
@interface TruliooCoreVerificationStatus : TruliooCoreKotlinEnum<TruliooCoreVerificationStatus *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) TruliooCoreVerificationStatus *canBeProcessed __attribute__((swift_name("canBeProcessed")));
@property (class, readonly) TruliooCoreVerificationStatus *cannotBeClassified __attribute__((swift_name("cannotBeClassified")));
@property (class, readonly) TruliooCoreVerificationStatus *unsupportedDocument __attribute__((swift_name("unsupportedDocument")));
@property (class, readonly) TruliooCoreVerificationStatus *expiredDocument __attribute__((swift_name("expiredDocument")));
@property (class, readonly) TruliooCoreVerificationStatus *glare __attribute__((swift_name("glare")));
@property (class, readonly) TruliooCoreVerificationStatus *blur __attribute__((swift_name("blur")));
@property (class, readonly) TruliooCoreVerificationStatus *skewed __attribute__((swift_name("skewed")));
@property (class, readonly) TruliooCoreVerificationStatus *error __attribute__((swift_name("error")));
+ (TruliooCoreKotlinArray<TruliooCoreVerificationStatus *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreVerificationStatus *> *entries __attribute__((swift_name("entries")));
@end
...
- (void)logImageMetaDataType:(TruliooCoreAPIContractStepType *)type sizeInBytes:(int32_t)sizeInBytes __attribute__((swift_name("logImageMetaData(type:sizeInBytes:)")));
...
- (id<TruliooCoreIEnvironmentConfig>)environment __attribute__((swift_name("environment()")));
- (id<TruliooCoreIFeatureConfig>)featureConfig __attribute__((swift_name("featureConfig()")));
- (id<TruliooCoreIImageManager>)imageManager __attribute__((swift_name("imageManager()")));
...
- (void)saveImageStep:(TruliooCoreAPIContractStepType *)step image:(id<TruliooCoreIImageParcel>)image __attribute__((swift_name("saveImage(step:image:)")));
...
- (NSString *)hostName __attribute__((swift_name("hostName()")));
- (void)onInit __attribute__((swift_name("onInit()")));
- (void)setAsSafeToTearDown __attribute__((swift_name("setAsSafeToTearDown()")));
- (void)setHostNameName:(NSString *)name __attribute__((swift_name("setHostName(name:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ConfigurationError.CameraCaptureRequired")))
@interface TruliooCoreConfigurationErrorCameraCaptureRequired : TruliooCoreConfigurationError
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)cameraCaptureRequired __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreConfigurationErrorCameraCaptureRequired *shared __attribute__((swift_name("shared")));
@property (readonly) int32_t code __attribute__((swift_name("code")));
@property (readonly) NSString *message __attribute__((swift_name("message")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ConfigurationError.CameraConfigurationError")))
@interface TruliooCoreConfigurationErrorCameraConfigurationError : TruliooCoreConfigurationError
- (instancetype)initWithCameraId:(NSString * _Nullable)cameraId __attribute__((swift_name("init(cameraId:)"))) __attribute__((objc_designated_initializer));
@property (readonly) int32_t code __attribute__((swift_name("code")));
@property (readonly) NSString *message __attribute__((swift_name("message")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ConfigurationError.CameraFeedConfigurationError")))
@interface TruliooCoreConfigurationErrorCameraFeedConfigurationError : TruliooCoreConfigurationError
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)cameraFeedConfigurationError __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreConfigurationErrorCameraFeedConfigurationError *shared __attribute__((swift_name("shared")));
@property (readonly) int32_t code __attribute__((swift_name("code")));
@property (readonly) NSString *message __attribute__((swift_name("message")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ConfigurationError.RequestNotSupported")))
@interface TruliooCoreConfigurationErrorRequestNotSupported : TruliooCoreConfigurationError
- (instancetype)initWithMessage:(NSString * _Nullable)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer));
@property (readonly) int32_t code __attribute__((swift_name("code")));
@property (readonly) NSString *message __attribute__((swift_name("message")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HandoverError.QrCodeError")))
@interface TruliooCoreHandoverErrorQrCodeError : TruliooCoreHandoverError
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)qrCodeError __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreHandoverErrorQrCodeError *shared __attribute__((swift_name("shared")));
@property (readonly) int32_t code __attribute__((swift_name("code")));
@property (readonly) NSString *message __attribute__((swift_name("message")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HandoverError.SendSMSError")))
@interface TruliooCoreHandoverErrorSendSMSError : TruliooCoreHandoverError
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)sendSMSError __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreHandoverErrorSendSMSError *shared __attribute__((swift_name("shared")));
@property (readonly) int32_t code __attribute__((swift_name("code")));
@property (readonly) NSString *message __attribute__((swift_name("message")));
@end
...
@interface TruliooCoreRequestError : TruliooCoreTruliooError
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
@property (readonly) int32_t code __attribute__((swift_name("code")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RequestError.NoInternet")))
@interface TruliooCoreRequestErrorNoInternet : TruliooCoreRequestError
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)noInternet __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreRequestErrorNoInternet *shared __attribute__((swift_name("shared")));
@property (readonly) int32_t code __attribute__((swift_name("code")));
@property (readonly) NSString *message __attribute__((swift_name("message")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RequestError.RequestFailure")))
@interface TruliooCoreRequestErrorRequestFailure : TruliooCoreRequestError
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)requestFailure __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreRequestErrorRequestFailure *shared __attribute__((swift_name("shared")));
@property (readonly) int32_t code __attribute__((swift_name("code")));
@property (readonly) NSString *message __attribute__((swift_name("message")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RequestError.ServerDown")))
@interface TruliooCoreRequestErrorServerDown : TruliooCoreRequestError
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)serverDown __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreRequestErrorServerDown *shared __attribute__((swift_name("shared")));
@property (readonly) int32_t code __attribute__((swift_name("code")));
@property (readonly) NSString *message __attribute__((swift_name("message")));
@end
...
- (BOOL)isDefaultOneSided __attribute__((swift_name("isDefaultOneSided()")));
@end
...
- (BOOL)isEnableNewCropping __attribute__((swift_name("isEnableNewCropping()")));
...
@property (readonly) TruliooCoreAPIContractFeatureConfigPostCaptureConfig *postCaptureConfig __attribute__((swift_name("postCaptureConfig")));
@property (readonly) TruliooCoreAPIContractFeatureConfigD2mSmsConfig *smsConfig __attribute__((swift_name("smsConfig")));
@end
...
@required
- (void)addAcceptedFrontImageIdId:(NSString *)id __attribute__((swift_name("addAcceptedFrontImageId(id:)")));
- (void)addUploadedImageTypeType:(TruliooCoreAPIContractStepType *)type __attribute__((swift_name("addUploadedImageType(type:)")));
- (NSString * _Nullable)getAcceptedFrontImageId __attribute__((swift_name("getAcceptedFrontImageId()")));
- (BOOL)isUploadComplete __attribute__((swift_name("isUploadComplete()")));
- (BOOL)isUploadCompleteForType:(TruliooCoreAPIContractStepType *)type __attribute__((swift_name("isUploadCompleteFor(type:)")));
- (void)reset __attribute__((swift_name("reset()")));
@end
...
- (int32_t)totalCaptured __attribute__((swift_name("totalCaptured()")));
...
- (id<TruliooCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@property (readonly) TruliooCoreStep *NONE_STEP __attribute__((swift_name("NONE_STEP")));
@end
...
- (NSString *)hostEnvironment:(TruliooCoreEnvironmentsENVIRONMENT *)environment __attribute__((swift_name("host(environment:)")));
- (void)setRegionRegion:(NSString *)region __attribute__((swift_name("setRegion(region:)")));
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) TruliooCoreEnvironmentsENVIRONMENTCompanion *companion __attribute__((swift_name("companion")));
...
@property (readonly) NSString *code_ __attribute__((swift_name("code_")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Environments.ENVIRONMENTCompanion")))
@interface TruliooCoreEnvironmentsENVIRONMENTCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreEnvironmentsENVIRONMENTCompanion *shared __attribute__((swift_name("shared")));
- (TruliooCoreEnvironmentsENVIRONMENT *)currentEnv __attribute__((swift_name("currentEnv()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Environments.Region")))
@interface TruliooCoreEnvironmentsRegion : TruliooCoreKotlinEnum<TruliooCoreEnvironmentsRegion *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) TruliooCoreEnvironmentsRegionCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) TruliooCoreEnvironmentsRegion *us __attribute__((swift_name("us")));
@property (class, readonly) TruliooCoreEnvironmentsRegion *ca __attribute__((swift_name("ca")));
@property (class, readonly) TruliooCoreEnvironmentsRegion *eu __attribute__((swift_name("eu")));
@property (class, readonly) TruliooCoreEnvironmentsRegion *apac __attribute__((swift_name("apac")));
+ (TruliooCoreKotlinArray<TruliooCoreEnvironmentsRegion *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreEnvironmentsRegion *> *entries __attribute__((swift_name("entries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Environments.RegionCompanion")))
@interface TruliooCoreEnvironmentsRegionCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreEnvironmentsRegionCompanion *shared __attribute__((swift_name("shared")));
- (TruliooCoreEnvironmentsRegion *)fromCodeCode:(NSString *)code __attribute__((swift_name("fromCode(code:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("APIContract.FeatureConfigD2mSmsConfig")))
@interface TruliooCoreAPIContractFeatureConfigD2mSmsConfig : TruliooCoreBase
...
@property (class, readonly, getter=companion) TruliooCoreAPIContractFeatureConfigD2mSmsConfigCompanion *companion __attribute__((swift_name("companion")));
- (TruliooCoreAPIContractFeatureConfigD2mSmsConfig *)doCopyEnabled:(BOOL)enabled __attribute__((swift_name("doCopy(enabled:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("APIContract.FeatureConfigD2mSmsConfigCompanion")))
@interface TruliooCoreAPIContractFeatureConfigD2mSmsConfigCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreAPIContractFeatureConfigD2mSmsConfigCompanion *shared __attribute__((swift_name("shared")));
- (id<TruliooCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (instancetype)initWithAuto:(BOOL)auto_ enabled:(BOOL)enabled captureDelay:(int64_t)captureDelay __attribute__((swift_name("init(auto:enabled:captureDelay:)"))) __attribute__((objc_designated_initializer));
...
- (TruliooCoreAPIContractFeatureConfigDocumentCapture *)doCopyAuto:(BOOL)auto_ enabled:(BOOL)enabled captureDelay:(int64_t)captureDelay __attribute__((swift_name("doCopy(auto:enabled:captureDelay:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly, getter=auto) BOOL auto_ __attribute__((swift_name("auto_")));
...
- (TruliooCoreAPIContractFeatureConfigPassportCapture *)doCopyAuto:(BOOL)auto_ enabled:(BOOL)enabled captureDelay:(int64_t)captureDelay __attribute__((swift_name("doCopy(auto:enabled:captureDelay:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly, getter=auto) BOOL auto_ __attribute__((swift_name("auto_")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("APIContract.FeatureConfigPostCaptureConfig")))
@interface TruliooCoreAPIContractFeatureConfigPostCaptureConfig : TruliooCoreBase
- (instancetype)initWithPostCaptureGlobalEnabled:(BOOL)postCaptureGlobalEnabled __attribute__((swift_name("init(postCaptureGlobalEnabled:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) TruliooCoreAPIContractFeatureConfigPostCaptureConfigCompanion *companion __attribute__((swift_name("companion")));
- (TruliooCoreAPIContractFeatureConfigPostCaptureConfig *)doCopyPostCaptureGlobalEnabled:(BOOL)postCaptureGlobalEnabled __attribute__((swift_name("doCopy(postCaptureGlobalEnabled:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) BOOL postCaptureGlobalEnabled __attribute__((swift_name("postCaptureGlobalEnabled")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("APIContract.FeatureConfigPostCaptureConfigCompanion")))
@interface TruliooCoreAPIContractFeatureConfigPostCaptureConfigCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreAPIContractFeatureConfigPostCaptureConfigCompanion *shared __attribute__((swift_name("shared")));
- (id<TruliooCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (instancetype)initWithConfigId:(NSString *)configId deviceData:(TruliooCoreAPIContractFeatureConfigDeviceData *)deviceData configurations:(NSArray<id<TruliooCoreAPIContractFeatureConfigIConfiguredFeature>> *)configurations d2mSms:(TruliooCoreAPIContractFeatureConfigD2mSmsConfig *)d2mSms postCaptureConfig:(TruliooCoreAPIContractFeatureConfigPostCaptureConfig *)postCaptureConfig __attribute__((swift_name("init(configId:deviceData:configurations:d2mSms:postCaptureConfig:)"))) __attribute__((objc_designated_initializer));
...
@property (readonly) TruliooCoreAPIContractFeatureConfigD2mSmsConfig *d2mSms __attribute__((swift_name("d2mSms")));
...
- (TruliooCoreAPIContractFeatureConfigSelfieCapture *)doCopyAuto:(BOOL)auto_ enabled:(BOOL)enabled captureDelay:(int64_t)captureDelay __attribute__((swift_name("doCopy(auto:enabled:captureDelay:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly, getter=auto) BOOL auto_ __attribute__((swift_name("auto_")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("APIContract.HandoverSMS")))
@interface TruliooCoreAPIContractHandoverSMS : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)sMS __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreAPIContractHandoverSMS *shared __attribute__((swift_name("shared")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("APIContract.HandoverSMSERROR")))
@interface TruliooCoreAPIContractHandoverSMSERROR : TruliooCoreKotlinEnum<TruliooCoreAPIContractHandoverSMSERROR *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) TruliooCoreAPIContractHandoverSMSERRORCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) TruliooCoreAPIContractHandoverSMSERROR *unknown __attribute__((swift_name("unknown")));
@property (class, readonly) TruliooCoreAPIContractHandoverSMSERROR *invalidFormat __attribute__((swift_name("invalidFormat")));
@property (class, readonly) TruliooCoreAPIContractHandoverSMSERROR *invalidCountry __attribute__((swift_name("invalidCountry")));
@property (class, readonly) TruliooCoreAPIContractHandoverSMSERROR *invalidType __attribute__((swift_name("invalidType")));
@property (class, readonly) TruliooCoreAPIContractHandoverSMSERROR *cannotSend __attribute__((swift_name("cannotSend")));
+ (TruliooCoreKotlinArray<TruliooCoreAPIContractHandoverSMSERROR *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreAPIContractHandoverSMSERROR *> *entries __attribute__((swift_name("entries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("APIContract.HandoverSMSERRORCompanion")))
@interface TruliooCoreAPIContractHandoverSMSERRORCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreAPIContractHandoverSMSERRORCompanion *shared __attribute__((swift_name("shared")));
- (id<TruliooCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
- (id<TruliooCoreKotlinx_serialization_coreKSerializer>)serializerTypeParamsSerializers:(TruliooCoreKotlinArray<id<TruliooCoreKotlinx_serialization_coreKSerializer>> *)typeParamsSerializers __attribute__((swift_name("serializer(typeParamsSerializers:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("APIContract.HandoverSMSRequest")))
@interface TruliooCoreAPIContractHandoverSMSRequest : TruliooCoreBase
- (instancetype)initWithPhoneNumber:(NSString *)phoneNumber linkToSend:(NSString *)linkToSend __attribute__((swift_name("init(phoneNumber:linkToSend:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) TruliooCoreAPIContractHandoverSMSRequestCompanion *companion __attribute__((swift_name("companion")));
- (TruliooCoreAPIContractHandoverSMSRequest *)doCopyPhoneNumber:(NSString *)phoneNumber linkToSend:(NSString *)linkToSend __attribute__((swift_name("doCopy(phoneNumber:linkToSend:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *linkToSend __attribute__((swift_name("linkToSend")));
@property (readonly) NSString *phoneNumber __attribute__((swift_name("phoneNumber")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("APIContract.HandoverSMSRequestCompanion")))
@interface TruliooCoreAPIContractHandoverSMSRequestCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreAPIContractHandoverSMSRequestCompanion *shared __attribute__((swift_name("shared")));
- (id<TruliooCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("APIContract.HandoverSMSResponse")))
@interface TruliooCoreAPIContractHandoverSMSResponse : TruliooCoreBase
- (instancetype)initWithError:(TruliooCoreAPIContractHandoverSMSERROR * _Nullable)error errorIndex:(TruliooCoreInt * _Nullable)errorIndex message:(NSString *)message __attribute__((swift_name("init(error:errorIndex:message:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) TruliooCoreAPIContractHandoverSMSResponseCompanion *companion __attribute__((swift_name("companion")));
- (TruliooCoreAPIContractHandoverSMSResponse *)doCopyError:(TruliooCoreAPIContractHandoverSMSERROR * _Nullable)error errorIndex:(TruliooCoreInt * _Nullable)errorIndex message:(NSString *)message __attribute__((swift_name("doCopy(error:errorIndex:message:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) TruliooCoreAPIContractHandoverSMSERROR * _Nullable error __attribute__((swift_name("error")));
@property (readonly) TruliooCoreInt * _Nullable errorIndex __attribute__((swift_name("errorIndex")));
@property (readonly) NSString *message __attribute__((swift_name("message")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("APIContract.HandoverSMSResponseCompanion")))
@interface TruliooCoreAPIContractHandoverSMSResponseCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreAPIContractHandoverSMSResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<TruliooCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("APIContract.RemoteLog")))
@interface TruliooCoreAPIContractRemoteLog : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)remoteLog __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreAPIContractRemoteLog *shared __attribute__((swift_name("shared")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("APIContract.RemoteLogLog")))
@interface TruliooCoreAPIContractRemoteLogLog : TruliooCoreBase
- (instancetype)initWithType:(TruliooCoreTruliooLoggerSeverity *)type message:(NSString *)message stackTrace:(NSString *)stackTrace __attribute__((swift_name("init(type:message:stackTrace:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) TruliooCoreAPIContractRemoteLogLogCompanion *companion __attribute__((swift_name("companion")));
- (TruliooCoreAPIContractRemoteLogLog *)doCopyType:(TruliooCoreTruliooLoggerSeverity *)type message:(NSString *)message stackTrace:(NSString *)stackTrace __attribute__((swift_name("doCopy(type:message:stackTrace:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *message __attribute__((swift_name("message")));
@property (readonly) NSString *stackTrace __attribute__((swift_name("stackTrace")));
@property (readonly) TruliooCoreTruliooLoggerSeverity *type __attribute__((swift_name("type")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("APIContract.RemoteLogLogCompanion")))
@interface TruliooCoreAPIContractRemoteLogLogCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreAPIContractRemoteLogLogCompanion *shared __attribute__((swift_name("shared")));
- (id<TruliooCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@property (class, readonly) TruliooCoreAPIContractStepType *initialization __attribute__((swift_name("initialization")));
...
@property (class, readonly) TruliooCoreAPIContractStepType *none __attribute__((swift_name("none")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)sendSMSPhoneNumber:(NSString *)phoneNumber linkToSend:(NSString *)linkToSend completionHandler:(void (^)(TruliooCoreEither<TruliooCoreAPIContractHandoverSMSResponse *, TruliooCoreKotlinError *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("sendSMS(phoneNumber:linkToSend:completionHandler:)")));
...
__attribute__((swift_name("IRemoteLoggingAPI")))
@protocol TruliooCoreIRemoteLoggingAPI
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)sendRemoteLogsRequest:(TruliooCoreAPIContractRemoteLogLog *)request completionHandler:(void (^)(TruliooCoreEither<TruliooCoreKotlinUnit *, TruliooCoreKotlinError *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("sendRemoteLogs(request:completionHandler:)")));
@end
...
@interface TruliooCoreFeedback : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)feedback __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreFeedback *shared __attribute__((swift_name("shared")));
- (TruliooCoreFeedbackDOCUMENT_IMAGE_SOURCE *)sourceFromStringValue:(NSString *)value __attribute__((swift_name("sourceFromString(value:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Feedback.DOCUMENT_IMAGE_SOURCE")))
@interface TruliooCoreFeedbackDOCUMENT_IMAGE_SOURCE : TruliooCoreKotlinEnum<TruliooCoreFeedbackDOCUMENT_IMAGE_SOURCE *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) TruliooCoreFeedbackDOCUMENT_IMAGE_SOURCE *any __attribute__((swift_name("any")));
@property (class, readonly) TruliooCoreFeedbackDOCUMENT_IMAGE_SOURCE *front __attribute__((swift_name("front")));
@property (class, readonly) TruliooCoreFeedbackDOCUMENT_IMAGE_SOURCE *back __attribute__((swift_name("back")));
+ (TruliooCoreKotlinArray<TruliooCoreFeedbackDOCUMENT_IMAGE_SOURCE *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreFeedbackDOCUMENT_IMAGE_SOURCE *> *entries __attribute__((swift_name("entries")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Feedback.DocumentQualityCheck")))
@interface TruliooCoreFeedbackDocumentQualityCheck : TruliooCoreBase
- (instancetype)initWithImageId:(NSString *)imageId hasDetection:(BOOL)hasDetection requiresBack:(BOOL)requiresBack isPassport:(BOOL)isPassport hasBlur:(BOOL)hasBlur __attribute__((swift_name("init(imageId:hasDetection:requiresBack:isPassport:hasBlur:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) TruliooCoreFeedbackDocumentQualityCheckCompanion *companion __attribute__((swift_name("companion")));
- (TruliooCoreFeedbackDocumentQualityCheck *)doCopyImageId:(NSString *)imageId hasDetection:(BOOL)hasDetection requiresBack:(BOOL)requiresBack isPassport:(BOOL)isPassport hasBlur:(BOOL)hasBlur __attribute__((swift_name("doCopy(imageId:hasDetection:requiresBack:isPassport:hasBlur:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) BOOL hasBlur __attribute__((swift_name("hasBlur")));
@property (readonly) BOOL hasDetection __attribute__((swift_name("hasDetection")));
@property (readonly) NSString *imageId __attribute__((swift_name("imageId")));
@property (readonly) BOOL isPassport __attribute__((swift_name("isPassport")));
@property (readonly) BOOL requiresBack __attribute__((swift_name("requiresBack")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Feedback.DocumentQualityCheckCompanion")))
@interface TruliooCoreFeedbackDocumentQualityCheckCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreFeedbackDocumentQualityCheckCompanion *shared __attribute__((swift_name("shared")));
- (TruliooCoreFeedbackDocumentQualityCheck *)emptyImageId:(NSString *)imageId __attribute__((swift_name("empty(imageId:)")));
- (id<TruliooCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeedbackAccumulator")))
@interface TruliooCoreFeedbackAccumulator : TruliooCoreBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)addFeedbackFeedback:(TruliooCoreTruliooImageFeedback *)feedback __attribute__((swift_name("addFeedback(feedback:)")));
- (TruliooCoreFeedbackResultThreshold * _Nullable)latestThreshold __attribute__((swift_name("latestThreshold()")));
- (void)sendFeedbackHistory __attribute__((swift_name("sendFeedbackHistory()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeedbackResult")))
@interface TruliooCoreFeedbackResult : TruliooCoreBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (TruliooCoreFeedbackResult *)addFeedbackFeedback:(TruliooCoreTruliooImageFeedback *)feedback __attribute__((swift_name("addFeedback(feedback:)")));
- (TruliooCoreFeedbackResultThreshold *)currentFeedback __attribute__((swift_name("currentFeedback()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeedbackResult.Threshold")))
@interface TruliooCoreFeedbackResultThreshold : TruliooCoreKotlinEnum<TruliooCoreFeedbackResultThreshold *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) TruliooCoreFeedbackResultThresholdCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) TruliooCoreFeedbackResultThreshold *success __attribute__((swift_name("success")));
@property (class, readonly) TruliooCoreFeedbackResultThreshold *tooClose __attribute__((swift_name("tooClose")));
@property (class, readonly) TruliooCoreFeedbackResultThreshold *tooFar __attribute__((swift_name("tooFar")));
@property (class, readonly) TruliooCoreFeedbackResultThreshold *detection __attribute__((swift_name("detection")));
@property (class, readonly) TruliooCoreFeedbackResultThreshold *blur __attribute__((swift_name("blur")));
@property (class, readonly) TruliooCoreFeedbackResultThreshold *none __attribute__((swift_name("none")));
+ (TruliooCoreKotlinArray<TruliooCoreFeedbackResultThreshold *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreFeedbackResultThreshold *> *entries __attribute__((swift_name("entries")));
- (BOOL)isAboveThresholdCount:(int32_t)count __attribute__((swift_name("isAboveThreshold(count:)")));
- (NSString *)stateString __attribute__((swift_name("stateString()")));
@property (readonly) float minOutputRatio __attribute__((swift_name("minOutputRatio")));
@property (readonly) int32_t priority __attribute__((swift_name("priority")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeedbackResult.ThresholdCompanion")))
@interface TruliooCoreFeedbackResultThresholdCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreFeedbackResultThresholdCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) int32_t FEEDBACK_SIZE __attribute__((swift_name("FEEDBACK_SIZE")));
@property (readonly) NSArray<TruliooCoreFeedbackResultThreshold *> *prioritized __attribute__((swift_name("prioritized")));
@end

__attribute__((swift_name("IDetectionType")))
@protocol TruliooCoreIDetectionType
@required
@end

__attribute__((swift_name("IImageQualityResponse")))
@protocol TruliooCoreIImageQualityResponse
@required
- (BOOL)failedQualityField:(TruliooCoreQualityCheck *)field __attribute__((swift_name("failedQuality(field:)")));
- (TruliooCoreDetectionType *)getDetectionType __attribute__((swift_name("getDetectionType()")));
- (BOOL)passedDetectionField:(TruliooCoreDetectionType *)field __attribute__((swift_name("passedDetection(field:)")));
- (BOOL)passedDocDetectionField:(TruliooCoreDocumentDetection *)field __attribute__((swift_name("passedDocDetection(field:)")));
- (BOOL)passedQualityField:(TruliooCoreQualityCheck *)field __attribute__((swift_name("passedQuality(field:)")));
- (BOOL)passedSelfieDetectionField:(TruliooCoreSelfieDetection *)field __attribute__((swift_name("passedSelfieDetection(field:)")));
- (TruliooCoreTruliooImageFeedback *)toTruliooImageFeedback __attribute__((swift_name("toTruliooImageFeedback()")));
@end

__attribute__((swift_name("IRemoteFeedbackFlow")))
@interface TruliooCoreIRemoteFeedbackFlow : TruliooCoreBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) TruliooCoreIRemoteFeedbackFlowCompanion *companion __attribute__((swift_name("companion")));
- (id<TruliooCoreKotlinx_coroutines_coreFlow>)eventFlow __attribute__((swift_name("eventFlow()")));
- (id<TruliooCoreKotlinx_coroutines_coreFlow>)eventFlowCaptureSdk __attribute__((swift_name("eventFlowCaptureSdk()")));
- (void)markInitialDetection __attribute__((swift_name("markInitialDetection()")));
- (void)reset __attribute__((swift_name("reset()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)sendEventEvent:(id<TruliooCoreIImageQualityResponse>)event completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("sendEvent(event:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("IRemoteFeedbackFlow.Companion")))
@interface TruliooCoreIRemoteFeedbackFlowCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreIRemoteFeedbackFlowCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) int64_t UX_CHANGE_LIMIT __attribute__((swift_name("UX_CHANGE_LIMIT")));
@end

__attribute__((swift_name("IRemoteRecognizer")))
@protocol TruliooCoreIRemoteRecognizer
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getDocumentFeedbackImage:(id<TruliooCoreIImageParcel>)image completionHandler:(void (^)(id<TruliooCoreKotlinx_coroutines_coreFlow> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getDocumentFeedback(image:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getSelfieFeedbackImage:(id<TruliooCoreIImageParcel>)image completionHandler:(void (^)(id<TruliooCoreKotlinx_coroutines_coreFlow> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getSelfieFeedback(image:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)verifyDocumentImage:(id<TruliooCoreIImageParcel>)image completionHandler:(void (^)(id<TruliooCoreKotlinx_coroutines_coreFlow> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("verifyDocument(image:completionHandler:)")));
@end

__attribute__((swift_name("ImageVerifyResponse")))
@protocol TruliooCoreImageVerifyResponse
@required
- (BOOL)verifySuccess __attribute__((swift_name("verifySuccess()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RemoteFeedbackFlow")))
@interface TruliooCoreRemoteFeedbackFlow : TruliooCoreIRemoteFeedbackFlow
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RemoteRecognizer")))
@interface TruliooCoreRemoteRecognizer : TruliooCoreBase <TruliooCoreIRemoteRecognizer>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BackImageRequirement")))
@interface TruliooCoreBackImageRequirement : TruliooCoreKotlinEnum<TruliooCoreBackImageRequirement *> <TruliooCoreIDetectionType>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) TruliooCoreBackImageRequirementCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) TruliooCoreBackImageRequirement *backImageRequirementUnspecified __attribute__((swift_name("backImageRequirementUnspecified")));
@property (class, readonly) TruliooCoreBackImageRequirement *backImageRequirementNotRequired __attribute__((swift_name("backImageRequirementNotRequired")));
@property (class, readonly) TruliooCoreBackImageRequirement *backImageRequirementRequired __attribute__((swift_name("backImageRequirementRequired")));
+ (TruliooCoreKotlinArray<TruliooCoreBackImageRequirement *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreBackImageRequirement *> *entries __attribute__((swift_name("entries")));
- (BOOL)isRequired __attribute__((swift_name("isRequired()")));
- (BOOL)isUnspecified __attribute__((swift_name("isUnspecified()")));
@property (readonly) int32_t value_ __attribute__((swift_name("value_")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BackImageRequirement.Companion")))
@interface TruliooCoreBackImageRequirementCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreBackImageRequirementCompanion *shared __attribute__((swift_name("shared")));
- (TruliooCoreBackImageRequirement *)fromIntValue:(int32_t)value __attribute__((swift_name("fromInt(value:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DocumentDetection")))
@interface TruliooCoreDocumentDetection : TruliooCoreKotlinEnum<TruliooCoreDocumentDetection *> <TruliooCoreIDetectionType>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) TruliooCoreDocumentDetectionCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) TruliooCoreDocumentDetection *documentUnspecified __attribute__((swift_name("documentUnspecified")));
@property (class, readonly) TruliooCoreDocumentDetection *documentFront __attribute__((swift_name("documentFront")));
@property (class, readonly) TruliooCoreDocumentDetection *documentBack __attribute__((swift_name("documentBack")));
@property (class, readonly) TruliooCoreDocumentDetection *documentPassport __attribute__((swift_name("documentPassport")));
+ (TruliooCoreKotlinArray<TruliooCoreDocumentDetection *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreDocumentDetection *> *entries __attribute__((swift_name("entries")));
@property (readonly) int32_t value_ __attribute__((swift_name("value_")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DocumentDetection.Companion")))
@interface TruliooCoreDocumentDetectionCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreDocumentDetectionCompanion *shared __attribute__((swift_name("shared")));
- (TruliooCoreDocumentDetection *)fromIntValue:(int32_t)value __attribute__((swift_name("fromInt(value:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DocumentExpirationCheck")))
@interface TruliooCoreDocumentExpirationCheck : TruliooCoreKotlinEnum<TruliooCoreDocumentExpirationCheck *> <TruliooCoreIDetectionType>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) TruliooCoreDocumentExpirationCheckCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) TruliooCoreDocumentExpirationCheck *documentExpirationCheckUnspecified __attribute__((swift_name("documentExpirationCheckUnspecified")));
@property (class, readonly) TruliooCoreDocumentExpirationCheck *documentExpirationCheckExpired __attribute__((swift_name("documentExpirationCheckExpired")));
@property (class, readonly) TruliooCoreDocumentExpirationCheck *documentExpirationCheckValid __attribute__((swift_name("documentExpirationCheckValid")));
+ (TruliooCoreKotlinArray<TruliooCoreDocumentExpirationCheck *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreDocumentExpirationCheck *> *entries __attribute__((swift_name("entries")));
- (BOOL)isExpired __attribute__((swift_name("isExpired()")));
@property (readonly) int32_t value_ __attribute__((swift_name("value_")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DocumentExpirationCheck.Companion")))
@interface TruliooCoreDocumentExpirationCheckCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreDocumentExpirationCheckCompanion *shared __attribute__((swift_name("shared")));
- (TruliooCoreDocumentExpirationCheck *)fromIntValue:(int32_t)value __attribute__((swift_name("fromInt(value:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DocumentSupportCheck")))
@interface TruliooCoreDocumentSupportCheck : TruliooCoreKotlinEnum<TruliooCoreDocumentSupportCheck *> <TruliooCoreIDetectionType>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) TruliooCoreDocumentSupportCheckCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) TruliooCoreDocumentSupportCheck *documentSupportCheckUnspecified __attribute__((swift_name("documentSupportCheckUnspecified")));
@property (class, readonly) TruliooCoreDocumentSupportCheck *documentSupportCheckDeclined __attribute__((swift_name("documentSupportCheckDeclined")));
@property (class, readonly) TruliooCoreDocumentSupportCheck *documentSupportCheckAccepted __attribute__((swift_name("documentSupportCheckAccepted")));
+ (TruliooCoreKotlinArray<TruliooCoreDocumentSupportCheck *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreDocumentSupportCheck *> *entries __attribute__((swift_name("entries")));
- (BOOL)isDeclined __attribute__((swift_name("isDeclined()")));
@property (readonly) int32_t value_ __attribute__((swift_name("value_")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DocumentSupportCheck.Companion")))
@interface TruliooCoreDocumentSupportCheckCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreDocumentSupportCheckCompanion *shared __attribute__((swift_name("shared")));
- (TruliooCoreDocumentSupportCheck *)fromIntValue:(int32_t)value __attribute__((swift_name("fromInt(value:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("QualityCheck")))
@interface TruliooCoreQualityCheck : TruliooCoreKotlinEnum<TruliooCoreQualityCheck *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) TruliooCoreQualityCheckCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) TruliooCoreQualityCheck *qualityCheckUnspecified __attribute__((swift_name("qualityCheckUnspecified")));
@property (class, readonly) TruliooCoreQualityCheck *qualityCheckFailed __attribute__((swift_name("qualityCheckFailed")));
@property (class, readonly) TruliooCoreQualityCheck *qualityCheckPassed __attribute__((swift_name("qualityCheckPassed")));
+ (TruliooCoreKotlinArray<TruliooCoreQualityCheck *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreQualityCheck *> *entries __attribute__((swift_name("entries")));
- (BOOL)isPassed __attribute__((swift_name("isPassed()")));
@property (readonly) int32_t value_ __attribute__((swift_name("value_")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("QualityCheck.Companion")))
@interface TruliooCoreQualityCheckCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreQualityCheckCompanion *shared __attribute__((swift_name("shared")));
- (TruliooCoreQualityCheck *)fromIntValue:(int32_t)value __attribute__((swift_name("fromInt(value:)")));
- (TruliooCoreQualityCheck *)fromIntAsBooleanValue:(int32_t)value __attribute__((swift_name("fromIntAsBoolean(value:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ResultCheck")))
@interface TruliooCoreResultCheck : TruliooCoreKotlinEnum<TruliooCoreResultCheck *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) TruliooCoreResultCheckCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) TruliooCoreResultCheck *resultCheckUnspecified __attribute__((swift_name("resultCheckUnspecified")));
@property (class, readonly) TruliooCoreResultCheck *resultCheckDeclined __attribute__((swift_name("resultCheckDeclined")));
@property (class, readonly) TruliooCoreResultCheck *resultCheckAccepted __attribute__((swift_name("resultCheckAccepted")));
+ (TruliooCoreKotlinArray<TruliooCoreResultCheck *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreResultCheck *> *entries __attribute__((swift_name("entries")));
- (BOOL)isDeclined __attribute__((swift_name("isDeclined()")));
- (BOOL)isUnspecified __attribute__((swift_name("isUnspecified()")));
@property (readonly) int32_t value_ __attribute__((swift_name("value_")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ResultCheck.Companion")))
@interface TruliooCoreResultCheckCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreResultCheckCompanion *shared __attribute__((swift_name("shared")));
- (TruliooCoreResultCheck *)fromIntValue:(int32_t)value __attribute__((swift_name("fromInt(value:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SelfieDetection")))
@interface TruliooCoreSelfieDetection : TruliooCoreKotlinEnum<TruliooCoreSelfieDetection *> <TruliooCoreIDetectionType>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) TruliooCoreSelfieDetectionCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) TruliooCoreSelfieDetection *selfieUnspecified __attribute__((swift_name("selfieUnspecified")));
@property (class, readonly) TruliooCoreSelfieDetection *selfieDetected __attribute__((swift_name("selfieDetected")));
+ (TruliooCoreKotlinArray<TruliooCoreSelfieDetection *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreSelfieDetection *> *entries __attribute__((swift_name("entries")));
@property (readonly) int32_t value_ __attribute__((swift_name("value_")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SelfieDetection.Companion")))
@interface TruliooCoreSelfieDetectionCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreSelfieDetectionCompanion *shared __attribute__((swift_name("shared")));
- (TruliooCoreSelfieDetection *)fromIntValue:(int32_t)value __attribute__((swift_name("fromInt(value:)")));
- (TruliooCoreSelfieDetection *)fromIntAsBooleanValue:(int32_t)value __attribute__((swift_name("fromIntAsBoolean(value:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DocumentDetectionDetail")))
@interface TruliooCoreDocumentDetectionDetail : TruliooCoreBase
- (instancetype)initWithRequiresBack:(BOOL)requiresBack isPassport:(BOOL)isPassport __attribute__((swift_name("init(requiresBack:isPassport:)"))) __attribute__((objc_designated_initializer));
- (TruliooCoreDocumentDetectionDetail *)doCopyRequiresBack:(BOOL)requiresBack isPassport:(BOOL)isPassport __attribute__((swift_name("doCopy(requiresBack:isPassport:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) BOOL isPassport __attribute__((swift_name("isPassport")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DocumentQualityCheckResponse")))
@interface TruliooCoreDocumentQualityCheckResponse : TruliooCoreBase <TruliooCoreIImageQualityResponse>
- (instancetype)initWithImageId:(NSString *)imageId documentDetected:(TruliooCoreQualityCheck *)documentDetected documentDetectionDetail:(TruliooCoreDocumentDetectionDetail *)documentDetectionDetail hasBlur:(TruliooCoreQualityCheck *)hasBlur hasGlare:(TruliooCoreQualityCheck *)hasGlare tooClose:(TruliooCoreQualityCheck *)tooClose tooFar:(TruliooCoreQualityCheck *)tooFar __attribute__((swift_name("init(imageId:documentDetected:documentDetectionDetail:hasBlur:hasGlare:tooClose:tooFar:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) TruliooCoreDocumentQualityCheckResponseCompanion *companion __attribute__((swift_name("companion")));
- (TruliooCoreDocumentQualityCheckResponse *)doCopyImageId:(NSString *)imageId documentDetected:(TruliooCoreQualityCheck *)documentDetected documentDetectionDetail:(TruliooCoreDocumentDetectionDetail *)documentDetectionDetail hasBlur:(TruliooCoreQualityCheck *)hasBlur hasGlare:(TruliooCoreQualityCheck *)hasGlare tooClose:(TruliooCoreQualityCheck *)tooClose tooFar:(TruliooCoreQualityCheck *)tooFar __attribute__((swift_name("doCopy(imageId:documentDetected:documentDetectionDetail:hasBlur:hasGlare:tooClose:tooFar:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (TruliooCoreDetectionType *)getDetectionType __attribute__((swift_name("getDetectionType()")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
- (TruliooCoreTruliooImageFeedback *)toTruliooImageFeedback __attribute__((swift_name("toTruliooImageFeedback()")));
@property (readonly) TruliooCoreQualityCheck *documentDetected __attribute__((swift_name("documentDetected")));
@property (readonly) TruliooCoreDocumentDetectionDetail *documentDetectionDetail __attribute__((swift_name("documentDetectionDetail")));
@property (readonly) BOOL feedbackIsAcceptable __attribute__((swift_name("feedbackIsAcceptable")));
@property (readonly) TruliooCoreQualityCheck *hasBlur __attribute__((swift_name("hasBlur")));
@property (readonly) TruliooCoreQualityCheck *hasGlare __attribute__((swift_name("hasGlare")));
@property (readonly) NSString *imageId __attribute__((swift_name("imageId")));
@property (readonly) TruliooCoreQualityCheck *tooClose __attribute__((swift_name("tooClose")));
@property (readonly) TruliooCoreQualityCheck *tooFar __attribute__((swift_name("tooFar")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DocumentQualityCheckResponse.Companion")))
@interface TruliooCoreDocumentQualityCheckResponseCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreDocumentQualityCheckResponseCompanion *shared __attribute__((swift_name("shared")));
- (TruliooCoreDocumentQualityCheckResponse *)mock __attribute__((swift_name("mock()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DocumentVerifyResponse")))
@interface TruliooCoreDocumentVerifyResponse : TruliooCoreBase <TruliooCoreImageVerifyResponse>
- (instancetype)initWithClassifiedDocument:(BOOL)classifiedDocument supportedDocumentCheck:(TruliooCoreDocumentSupportCheck *)supportedDocumentCheck documentExpirationCheck:(TruliooCoreDocumentExpirationCheck *)documentExpirationCheck backImageRequirement:(TruliooCoreBackImageRequirement *)backImageRequirement documentTypeAccepted:(TruliooCoreResultCheck *)documentTypeAccepted documentCountryAccepted:(TruliooCoreResultCheck *)documentCountryAccepted documentJurisdictionAccepted:(TruliooCoreResultCheck *)documentJurisdictionAccepted documentDetected:(TruliooCoreResultCheck *)documentDetected blur:(TruliooCoreResultCheck *)blur glare:(TruliooCoreResultCheck *)glare skewed:(TruliooCoreResultCheck *)skewed bright:(TruliooCoreResultCheck *)bright imageIds:(NSArray<NSString *> *)imageIds __attribute__((swift_name("init(classifiedDocument:supportedDocumentCheck:documentExpirationCheck:backImageRequirement:documentTypeAccepted:documentCountryAccepted:documentJurisdictionAccepted:documentDetected:blur:glare:skewed:bright:imageIds:)"))) __attribute__((objc_designated_initializer));
- (TruliooCoreDocumentVerifyResponse *)doCopyClassifiedDocument:(BOOL)classifiedDocument supportedDocumentCheck:(TruliooCoreDocumentSupportCheck *)supportedDocumentCheck documentExpirationCheck:(TruliooCoreDocumentExpirationCheck *)documentExpirationCheck backImageRequirement:(TruliooCoreBackImageRequirement *)backImageRequirement documentTypeAccepted:(TruliooCoreResultCheck *)documentTypeAccepted documentCountryAccepted:(TruliooCoreResultCheck *)documentCountryAccepted documentJurisdictionAccepted:(TruliooCoreResultCheck *)documentJurisdictionAccepted documentDetected:(TruliooCoreResultCheck *)documentDetected blur:(TruliooCoreResultCheck *)blur glare:(TruliooCoreResultCheck *)glare skewed:(TruliooCoreResultCheck *)skewed bright:(TruliooCoreResultCheck *)bright imageIds:(NSArray<NSString *> *)imageIds __attribute__((swift_name("doCopy(classifiedDocument:supportedDocumentCheck:documentExpirationCheck:backImageRequirement:documentTypeAccepted:documentCountryAccepted:documentJurisdictionAccepted:documentDetected:blur:glare:skewed:bright:imageIds:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (BOOL)hasMultipleDeclinedImageQualityCheck __attribute__((swift_name("hasMultipleDeclinedImageQualityCheck()")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
- (BOOL)verifySuccess __attribute__((swift_name("verifySuccess()")));
@property (readonly) TruliooCoreBackImageRequirement *backImageRequirement __attribute__((swift_name("backImageRequirement")));
@property (readonly) TruliooCoreResultCheck *blur __attribute__((swift_name("blur")));
@property (readonly) TruliooCoreResultCheck *bright __attribute__((swift_name("bright")));
@property (readonly) BOOL classifiedDocument __attribute__((swift_name("classifiedDocument")));
@property (readonly) TruliooCoreResultCheck *documentCountryAccepted __attribute__((swift_name("documentCountryAccepted")));
@property (readonly) TruliooCoreResultCheck *documentDetected __attribute__((swift_name("documentDetected")));
@property (readonly) TruliooCoreDocumentExpirationCheck *documentExpirationCheck __attribute__((swift_name("documentExpirationCheck")));
@property (readonly) TruliooCoreResultCheck *documentJurisdictionAccepted __attribute__((swift_name("documentJurisdictionAccepted")));
@property (readonly) TruliooCoreResultCheck *documentTypeAccepted __attribute__((swift_name("documentTypeAccepted")));
@property (readonly) TruliooCoreResultCheck *glare __attribute__((swift_name("glare")));
@property (readonly) NSArray<NSString *> *imageIds __attribute__((swift_name("imageIds")));
@property (readonly) TruliooCoreResultCheck *skewed __attribute__((swift_name("skewed")));
@property (readonly) TruliooCoreDocumentSupportCheck *supportedDocumentCheck __attribute__((swift_name("supportedDocumentCheck")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SelfieQualityCheckResponse")))
@interface TruliooCoreSelfieQualityCheckResponse : TruliooCoreBase <TruliooCoreIImageQualityResponse>
- (instancetype)initWithClientImageID:(NSString *)clientImageID selfieDetected:(TruliooCoreSelfieDetection *)selfieDetected hasBlur:(TruliooCoreQualityCheck *)hasBlur hasGlare:(TruliooCoreQualityCheck *)hasGlare multipleFaces:(TruliooCoreQualityCheck *)multipleFaces tooClose:(TruliooCoreQualityCheck *)tooClose tooFar:(TruliooCoreQualityCheck *)tooFar __attribute__((swift_name("init(clientImageID:selfieDetected:hasBlur:hasGlare:multipleFaces:tooClose:tooFar:)"))) __attribute__((objc_designated_initializer));
- (TruliooCoreSelfieQualityCheckResponse *)doCopyClientImageID:(NSString *)clientImageID selfieDetected:(TruliooCoreSelfieDetection *)selfieDetected hasBlur:(TruliooCoreQualityCheck *)hasBlur hasGlare:(TruliooCoreQualityCheck *)hasGlare multipleFaces:(TruliooCoreQualityCheck *)multipleFaces tooClose:(TruliooCoreQualityCheck *)tooClose tooFar:(TruliooCoreQualityCheck *)tooFar __attribute__((swift_name("doCopy(clientImageID:selfieDetected:hasBlur:hasGlare:multipleFaces:tooClose:tooFar:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (TruliooCoreDetectionType *)getDetectionType __attribute__((swift_name("getDetectionType()")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
- (TruliooCoreTruliooImageFeedback *)toTruliooImageFeedback __attribute__((swift_name("toTruliooImageFeedback()")));
@property (readonly) NSString *clientImageID __attribute__((swift_name("clientImageID")));
@property (readonly) BOOL feedbackIsAcceptable __attribute__((swift_name("feedbackIsAcceptable")));
@property (readonly) TruliooCoreQualityCheck *hasBlur __attribute__((swift_name("hasBlur")));
@property (readonly) TruliooCoreQualityCheck *hasGlare __attribute__((swift_name("hasGlare")));
@property (readonly) TruliooCoreQualityCheck *multipleFaces __attribute__((swift_name("multipleFaces")));
@property (readonly) TruliooCoreSelfieDetection *selfieDetected __attribute__((swift_name("selfieDetected")));
@property (readonly) TruliooCoreQualityCheck *tooClose __attribute__((swift_name("tooClose")));
@property (readonly) TruliooCoreQualityCheck *tooFar __attribute__((swift_name("tooFar")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SelfieVerifyResponse")))
@interface TruliooCoreSelfieVerifyResponse : TruliooCoreBase <TruliooCoreImageVerifyResponse>
- (instancetype)initWithCanBeProcessed:(BOOL)canBeProcessed noFace:(BOOL)noFace multipleFaces:(BOOL)multipleFaces poorImageQuality:(BOOL)poorImageQuality tampering:(BOOL)tampering __attribute__((swift_name("init(canBeProcessed:noFace:multipleFaces:poorImageQuality:tampering:)"))) __attribute__((objc_designated_initializer));
- (TruliooCoreSelfieVerifyResponse *)doCopyCanBeProcessed:(BOOL)canBeProcessed noFace:(BOOL)noFace multipleFaces:(BOOL)multipleFaces poorImageQuality:(BOOL)poorImageQuality tampering:(BOOL)tampering __attribute__((swift_name("doCopy(canBeProcessed:noFace:multipleFaces:poorImageQuality:tampering:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
- (BOOL)verifySuccess __attribute__((swift_name("verifySuccess()")));
@property (readonly) BOOL canBeProcessed __attribute__((swift_name("canBeProcessed")));
@property (readonly) BOOL multipleFaces __attribute__((swift_name("multipleFaces")));
@property (readonly) BOOL noFace __attribute__((swift_name("noFace")));
@property (readonly) BOOL poorImageQuality __attribute__((swift_name("poorImageQuality")));
@property (readonly) BOOL tampering __attribute__((swift_name("tampering")));
@end
...
@interface TruliooCoreDocumentRecognizer : TruliooCoreBase <TruliooCoreIRecognizer>
...
- (void)onResultImage:(id<TruliooCoreIImageParcel>)image __attribute__((swift_name("onResult(image:)")));
@end
...
@interface TruliooCoreImageRecognizer<T> : TruliooCoreBase <TruliooCoreIDocumentRecognizer, TruliooCoreIFaceRecognizer>
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CaptureRatios")))
@interface TruliooCoreCaptureRatios : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)captureRatios __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreCaptureRatios *shared __attribute__((swift_name("shared")));
- (float)getDocumentRatioDocumentType:(TruliooCoreDocumentType * _Nullable)documentType __attribute__((swift_name("getDocumentRatio(documentType:)")));
@property (readonly) float DOCUMENT_MODEL __attribute__((swift_name("DOCUMENT_MODEL")));
...
@property (readonly) float SELFIE_RATIO __attribute__((swift_name("SELFIE_RATIO")));
@end
...
@required
- (id<TruliooCoreIImageParcel>)cropAndResizeByMbParcel:(id<TruliooCoreIImageParcel>)parcel maxSizeInMb:(float)maxSizeInMb __attribute__((swift_name("cropAndResizeByMb(parcel:maxSizeInMb:)")));
...
- (id<TruliooCoreIImageParcel>)scaleForSizeResultParcel:(id<TruliooCoreIImageParcel>)parcel maxSizeInMb:(float)maxSizeInMb __attribute__((swift_name("scaleForSizeResult(parcel:maxSizeInMb:)")));
...
__attribute__((swift_name("IImageResizing")))
@protocol TruliooCoreIImageResizing
@required
- (id<TruliooCoreIImageParcel>)cropAndResizeParcel:(id<TruliooCoreIImageParcel>)parcel __attribute__((swift_name("cropAndResize(parcel:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImageResizing")))
@interface TruliooCoreImageResizing : TruliooCoreBase <TruliooCoreIImageResizing>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)imageResizing __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreImageResizing *shared __attribute__((swift_name("shared")));
- (id<TruliooCoreIImageParcel>)cropAndResizeParcel:(id<TruliooCoreIImageParcel>)parcel __attribute__((swift_name("cropAndResize(parcel:)")));
@end
...
- (void)addSubmitSessionPayloadPayload:(TruliooCoreSubmitSessionPayload *)payload __attribute__((swift_name("addSubmitSessionPayload(payload:)")));
...
@property (readonly) id<TruliooCoreKotlinx_coroutines_coreStateFlow> getIsSessionSubmitted __attribute__((swift_name("getIsSessionSubmitted")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SubmitSessionPayload")))
@interface TruliooCoreSubmitSessionPayload : TruliooCoreBase <TruliooCoreIOperationalQueuePayload>
- (instancetype)initWithCanRetry:(BOOL)canRetry __attribute__((swift_name("init(canRetry:)"))) __attribute__((objc_designated_initializer));
- (TruliooCoreSubmitSessionPayload *)doCopyCanRetry:(BOOL)canRetry __attribute__((swift_name("doCopy(canRetry:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property BOOL canRetry __attribute__((swift_name("canRetry")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("IErrorEventParcelFATAL_ERROR")))
@interface TruliooCoreIErrorEventParcelFATAL_ERROR : TruliooCoreBase <TruliooCoreIErrorEventParcel>
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("IUserAlertEventParcelINTERNET_RESTORED")))
@interface TruliooCoreIUserAlertEventParcelINTERNET_RESTORED : TruliooCoreBase <TruliooCoreIEventParcel>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)iNTERNET_RESTORED __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreIUserAlertEventParcelINTERNET_RESTORED *shared __attribute__((swift_name("shared")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@required
- (void)debugThrowable:(TruliooCoreKotlinThrowable * _Nullable)throwable message:(NSString *(^)(void))message __attribute__((swift_name("debug(throwable:message:)")));

/**
 * @note This method converts instances of Exception to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)errorThrowable:(TruliooCoreKotlinThrowable * _Nullable)throwable error:(NSError * _Nullable * _Nullable)error message:(NSString *(^)(void))message __attribute__((swift_name("error(throwable:message:)")));
- (void)infoThrowable:(TruliooCoreKotlinThrowable * _Nullable)throwable message:(NSString *(^)(void))message __attribute__((swift_name("info(throwable:message:)")));
- (NSArray<TruliooCoreAPIContractRemoteLogLog *> *)remote __attribute__((swift_name("remote()")));
- (void)reset __attribute__((swift_name("reset()")));
- (void)warningThrowable:(TruliooCoreKotlinThrowable * _Nullable)throwable message:(NSString *(^)(void))message __attribute__((swift_name("warning(throwable:message:)")));
@end
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) TruliooCoreCoreLoggerCompanion *companion __attribute__((swift_name("companion")));
- (void)debugThrowable:(TruliooCoreKotlinThrowable * _Nullable)throwable message:(NSString *(^)(void))message __attribute__((swift_name("debug(throwable:message:)")));
...
- (BOOL)errorThrowable:(TruliooCoreKotlinThrowable * _Nullable)throwable error:(NSError * _Nullable * _Nullable)error message:(NSString *(^)(void))message __attribute__((swift_name("error(throwable:message:)")));
- (void)infoThrowable:(TruliooCoreKotlinThrowable * _Nullable)throwable message:(NSString *(^)(void))message __attribute__((swift_name("info(throwable:message:)")));
- (void)logSeverity:(TruliooCoreTruliooLoggerSeverity *)severity throwable:(TruliooCoreKotlinThrowable * _Nullable)throwable message:(NSString *(^)(void))message __attribute__((swift_name("log(severity:throwable:message:)")));
- (NSArray<TruliooCoreAPIContractRemoteLogLog *> *)remote __attribute__((swift_name("remote()")));
- (void)reset __attribute__((swift_name("reset()")));
- (void)warningThrowable:(TruliooCoreKotlinThrowable * _Nullable)throwable message:(NSString *(^)(void))message __attribute__((swift_name("warning(throwable:message:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreLogger.Companion")))
@interface TruliooCoreCoreLoggerCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreCoreLoggerCompanion *shared __attribute__((swift_name("shared")));
@end

__attribute__((swift_name("ILogWriter")))
@protocol TruliooCoreILogWriter
@required
- (void)logSeverity:(TruliooCoreTruliooLoggerSeverity *)severity message:(NSString *)message tag:(NSString *)tag throwable:(TruliooCoreKotlinThrowable * _Nullable)throwable __attribute__((swift_name("log(severity:message:tag:throwable:)")));
- (NSString *)logStringSeverity:(TruliooCoreTruliooLoggerSeverity *)severity message:(NSString *)message tag:(NSString *)tag __attribute__((swift_name("logString(severity:message:tag:)")));
@property (readonly) TruliooCoreTruliooLoggerSeverity *minSeverity __attribute__((swift_name("minSeverity")));
@end

__attribute__((swift_name("ILoggerConfig")))
@protocol TruliooCoreILoggerConfig
@required
@property (readonly) NSArray<id<TruliooCoreILogWriter>> *writer __attribute__((swift_name("writer")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LocalWriter")))
@interface TruliooCoreLocalWriter : TruliooCoreBase <TruliooCoreILogWriter>
- (instancetype)initWithMinSeverity:(TruliooCoreTruliooLoggerSeverity *)minSeverity __attribute__((swift_name("init(minSeverity:)"))) __attribute__((objc_designated_initializer));
- (void)logSeverity:(TruliooCoreTruliooLoggerSeverity *)severity message:(NSString *)message tag:(NSString *)tag throwable:(TruliooCoreKotlinThrowable * _Nullable)throwable __attribute__((swift_name("log(severity:message:tag:throwable:)")));
@property (readonly) TruliooCoreTruliooLoggerSeverity *minSeverity __attribute__((swift_name("minSeverity")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RemoteWriter")))
@interface TruliooCoreRemoteWriter : TruliooCoreBase <TruliooCoreILogWriter>
- (instancetype)initWithMinSeverity:(TruliooCoreTruliooLoggerSeverity *)minSeverity __attribute__((swift_name("init(minSeverity:)"))) __attribute__((objc_designated_initializer));
- (void)logSeverity:(TruliooCoreTruliooLoggerSeverity *)severity message:(NSString *)message tag:(NSString *)tag throwable:(TruliooCoreKotlinThrowable * _Nullable)throwable __attribute__((swift_name("log(severity:message:tag:throwable:)")));
- (NSString *)logStringSeverity:(TruliooCoreTruliooLoggerSeverity *)severity message:(NSString *)message tag:(NSString *)tag __attribute__((swift_name("logString(severity:message:tag:)")));
@property (readonly) TruliooCoreTruliooLoggerSeverity *minSeverity __attribute__((swift_name("minSeverity")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TruliooLogger")))
@interface TruliooCoreTruliooLogger : TruliooCoreBase
- (instancetype)initWithConfig:(id<TruliooCoreILoggerConfig>)config tag:(NSString *)tag __attribute__((swift_name("init(config:tag:)"))) __attribute__((objc_designated_initializer));
@property (readonly) id<TruliooCoreILoggerConfig> config __attribute__((swift_name("config")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TruliooLogger.Severity")))
@interface TruliooCoreTruliooLoggerSeverity : TruliooCoreKotlinEnum<TruliooCoreTruliooLoggerSeverity *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) TruliooCoreTruliooLoggerSeverityCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) TruliooCoreTruliooLoggerSeverity *verbose __attribute__((swift_name("verbose")));
@property (class, readonly) TruliooCoreTruliooLoggerSeverity *debug __attribute__((swift_name("debug")));
@property (class, readonly) TruliooCoreTruliooLoggerSeverity *info __attribute__((swift_name("info")));
@property (class, readonly) TruliooCoreTruliooLoggerSeverity *warn __attribute__((swift_name("warn")));
@property (class, readonly) TruliooCoreTruliooLoggerSeverity *error __attribute__((swift_name("error")));
+ (TruliooCoreKotlinArray<TruliooCoreTruliooLoggerSeverity *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreTruliooLoggerSeverity *> *entries __attribute__((swift_name("entries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TruliooLogger.SeverityCompanion")))
@interface TruliooCoreTruliooLoggerSeverityCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreTruliooLoggerSeverityCompanion *shared __attribute__((swift_name("shared")));
- (id<TruliooCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
- (id<TruliooCoreKotlinx_serialization_coreKSerializer>)serializerTypeParamsSerializers:(TruliooCoreKotlinArray<id<TruliooCoreKotlinx_serialization_coreKSerializer>> *)typeParamsSerializers __attribute__((swift_name("serializer(typeParamsSerializers:)")));
@end
...
- (TruliooCoreStep *)getCurrentStep __attribute__((swift_name("getCurrentStep()")));
- (NSMutableArray<id<TruliooCoreIMetadata>> *)getQueuedMetadata __attribute__((swift_name("getQueuedMetadata()")));
- (TruliooCoreEither<TruliooCoreStep *, TruliooCoreKotlinError *> *)getStepType:(TruliooCoreAPIContractStepType *)type __attribute__((swift_name("getStep(type:)")));
...
- (void)requestStepUpdateType:(TruliooCoreAPIContractStepType *)type newStatus:(TruliooCoreAPIContractStepStatus *)newStatus __attribute__((swift_name("requestStepUpdate(type:newStatus:)")));
- (void)reset __attribute__((swift_name("reset()")));
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) TruliooCoreStepServiceCompanion *companion __attribute__((swift_name("companion")));
- (id<TruliooCoreIStepService>)addImageImage:(id<TruliooCoreIImageParcel>)image stepType:(TruliooCoreAPIContractStepType *)stepType __attribute__((swift_name("addImage(image:stepType:)")));
- (id<TruliooCoreIStepService>)addMetadataData:(id<TruliooCoreIMetadata>)data __attribute__((swift_name("addMetadata(data:)")));
- (void)confirmNewStepStep:(TruliooCoreStep *)step __attribute__((swift_name("confirmNewStep(step:)")));
- (void)confirmStepUpdatePayload:(TruliooCoreStepUpdatePayload *)payload __attribute__((swift_name("confirmStepUpdate(payload:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("StepService.Companion")))
@interface TruliooCoreStepServiceCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreStepServiceCompanion *shared __attribute__((swift_name("shared")));
- (TruliooCoreKotlinError *)noStepErrorType:(TruliooCoreAPIContractStepType *)type __attribute__((swift_name("noStepError(type:)")));
@end
...
- (void)reset __attribute__((swift_name("reset()")));
- (int32_t)start __attribute__((swift_name("start()")));
...
@property (class, readonly) TruliooCoreLocalizedKeys *smsInputTooltipTitle __attribute__((swift_name("smsInputTooltipTitle")));
@property (class, readonly) TruliooCoreLocalizedKeys *smsInputTooltipBody __attribute__((swift_name("smsInputTooltipBody")));
@property (class, readonly) TruliooCoreLocalizedKeys *or_ __attribute__((swift_name("or_")));
@property (class, readonly) TruliooCoreLocalizedKeys *enterMobileNumberForSmsLink __attribute__((swift_name("enterMobileNumberForSmsLink")));
@property (class, readonly) TruliooCoreLocalizedKeys *sendLink __attribute__((swift_name("sendLink")));
@property (class, readonly) TruliooCoreLocalizedKeys *sending __attribute__((swift_name("sending")));
@property (class, readonly) TruliooCoreLocalizedKeys *linkSuccessfullySent __attribute__((swift_name("linkSuccessfullySent")));
@property (class, readonly) TruliooCoreLocalizedKeys *invalidPhoneNumber __attribute__((swift_name("invalidPhoneNumber")));
@property (class, readonly) TruliooCoreLocalizedKeys *unableToSendSms __attribute__((swift_name("unableToSendSms")));
@property (class, readonly) TruliooCoreLocalizedKeys *smsResendLimitReached __attribute__((swift_name("smsResendLimitReached")));
@property (class, readonly) TruliooCoreLocalizedKeys *retryInProgress __attribute__((swift_name("retryInProgress")));
@property (class, readonly) TruliooCoreLocalizedKeys *unsupportedDocument __attribute__((swift_name("unsupportedDocument")));
@property (class, readonly) TruliooCoreLocalizedKeys *documentFromCountryNotAccepted __attribute__((swift_name("documentFromCountryNotAccepted")));
@property (class, readonly) TruliooCoreLocalizedKeys *documentTypeNotAccepted __attribute__((swift_name("documentTypeNotAccepted")));
@property (class, readonly) TruliooCoreLocalizedKeys *noDocumentDetected __attribute__((swift_name("noDocumentDetected")));
@property (class, readonly) TruliooCoreLocalizedKeys *documentNotDetectedRetakeAgain __attribute__((swift_name("documentNotDetectedRetakeAgain")));
@property (class, readonly) TruliooCoreLocalizedKeys *holdThePhoneSteadyThenRetake __attribute__((swift_name("holdThePhoneSteadyThenRetake")));
@property (class, readonly) TruliooCoreLocalizedKeys *documentHasGlare __attribute__((swift_name("documentHasGlare")));
@property (class, readonly) TruliooCoreLocalizedKeys *retakePhotoInBrightArea __attribute__((swift_name("retakePhotoInBrightArea")));
@property (class, readonly) TruliooCoreLocalizedKeys *adjustDocumentAngle __attribute__((swift_name("adjustDocumentAngle")));
@property (class, readonly) TruliooCoreLocalizedKeys *placeDocumentOnFlatSurface __attribute__((swift_name("placeDocumentOnFlatSurface")));
@property (class, readonly) TruliooCoreLocalizedKeys *documentTooDark __attribute__((swift_name("documentTooDark")));
@property (class, readonly) TruliooCoreLocalizedKeys *moveToBrighterLightingAndRetake __attribute__((swift_name("moveToBrighterLightingAndRetake")));
@property (class, readonly) TruliooCoreLocalizedKeys *documentIsExpired __attribute__((swift_name("documentIsExpired")));
@property (class, readonly) TruliooCoreLocalizedKeys *retakePhotoWithDocumentNotExpired __attribute__((swift_name("retakePhotoWithDocumentNotExpired")));
@property (class, readonly) TruliooCoreLocalizedKeys *weHaveDetectedIssues __attribute__((swift_name("weHaveDetectedIssues")));
@property (class, readonly) TruliooCoreLocalizedKeys *toGetOptimalVerificationYouShould __attribute__((swift_name("toGetOptimalVerificationYouShould")));
@property (class, readonly) TruliooCoreLocalizedKeys *ensureYouAreInGoodLighting __attribute__((swift_name("ensureYouAreInGoodLighting")));
@property (class, readonly) TruliooCoreLocalizedKeys *placeIdOnFlatAndDarkSurface __attribute__((swift_name("placeIdOnFlatAndDarkSurface")));
@property (class, readonly) TruliooCoreLocalizedKeys *avoidBlurGlareReflections __attribute__((swift_name("avoidBlurGlareReflections")));
@property (class, readonly) TruliooCoreLocalizedKeys *documentTooFar __attribute__((swift_name("documentTooFar")));
@property (class, readonly) TruliooCoreLocalizedKeys *moveCloserIn __attribute__((swift_name("moveCloserIn")));
@property (class, readonly) TruliooCoreLocalizedKeys *moveCloserAndRetake __attribute__((swift_name("moveCloserAndRetake")));
@property (class, readonly) TruliooCoreLocalizedKeys *documentTooClose __attribute__((swift_name("documentTooClose")));
@property (class, readonly) TruliooCoreLocalizedKeys *moveFurther __attribute__((swift_name("moveFurther")));
@property (class, readonly) TruliooCoreLocalizedKeys *moveFurtherAndRetake __attribute__((swift_name("moveFurtherAndRetake")));
@property (class, readonly) TruliooCoreLocalizedKeys *retakeWithBackId __attribute__((swift_name("retakeWithBackId")));
@property (class, readonly) TruliooCoreLocalizedKeys *flipIdAndRetake __attribute__((swift_name("flipIdAndRetake")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CaptureSdkMetadata")))
@interface TruliooCoreCaptureSdkMetadata : TruliooCoreBase <TruliooCoreIMetadataBuilder>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)captureSdkMetadata __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreCaptureSdkMetadata *shared __attribute__((swift_name("shared")));
- (id<TruliooCoreIMetadata>)autoCaptureFeedbackResponseImageFeedbackCaptured:(TruliooCoreTruliooImageFeedback *)imageFeedbackCaptured __attribute__((swift_name("autoCaptureFeedbackResponse(imageFeedbackCaptured:)")));
- (id<TruliooCoreIMetadata>)autoCaptureFeedbackStarted __attribute__((swift_name("autoCaptureFeedbackStarted()")));
- (id<TruliooCoreIMetadata>)cameraComponentCreatedId:(NSString *)id __attribute__((swift_name("cameraComponentCreated(id:)")));
- (id<TruliooCoreIMetadata>)cameraComponentRenderCameraDetectionType:(NSString *)cameraDetectionType __attribute__((swift_name("cameraComponentRender(cameraDetectionType:)")));
- (id<TruliooCoreIMetadata>)cameraComponentStoppedId:(NSString *)id __attribute__((swift_name("cameraComponentStopped(id:)")));
- (id<TruliooCoreIMetadata>)cameraDetectionTypeDetectionType:(TruliooCoreDetectionType *)detectionType __attribute__((swift_name("cameraDetectionType(detectionType:)")));
- (id<TruliooCoreIMetadata>)detectionTypeStoppedDetectionType:(TruliooCoreDetectionType *)detectionType __attribute__((swift_name("detectionTypeStopped(detectionType:)")));
- (id<TruliooCoreIMetadata>)isCaptureSDK __attribute__((swift_name("isCaptureSDK()")));
- (id<TruliooCoreIMetadata>)manualCaptureFeedbackResponseImageFeedbackCaptured:(TruliooCoreTruliooImageFeedback *)imageFeedbackCaptured __attribute__((swift_name("manualCaptureFeedbackResponse(imageFeedbackCaptured:)")));
- (id<TruliooCoreIMetadata>)manualCaptureFeedbackTriggeredId:(NSString *)id __attribute__((swift_name("manualCaptureFeedbackTriggered(id:)")));
- (id<TruliooCoreIMetadata>)postCaptureDocVerifyResponseVerifyResponse:(TruliooCoreTruliooVerifyResponse *)verifyResponse __attribute__((swift_name("postCaptureDocVerifyResponse(verifyResponse:)")));
- (id<TruliooCoreIMetadata>)postCaptureDocVerifyResponseWebVerifyResponse:(NSString *)verifyResponse __attribute__((swift_name("postCaptureDocVerifyResponseWeb(verifyResponse:)")));
- (id<TruliooCoreIMetadata>)postCaptureFeedbackCalled __attribute__((swift_name("postCaptureFeedbackCalled()")));
- (id<TruliooCoreIMetadata>)postCaptureRetryCountRetryCount:(int32_t)retryCount __attribute__((swift_name("postCaptureRetryCount(retryCount:)")));
- (id<TruliooCoreIMetadata>)postCaptureServerResponseServerResponse:(TruliooCoreDocumentVerifyResponse *)serverResponse __attribute__((swift_name("postCaptureServerResponse(serverResponse:)")));
- (id<TruliooCoreIMetadata>)sendSdkVersion __attribute__((swift_name("sendSdkVersion()")));
- (id<TruliooCoreIMetadata>)submitTransactionTriggered __attribute__((swift_name("submitTransactionTriggered()")));
@end
...
- (id<TruliooCoreIMetadata>)smsResponseResponse:(TruliooCoreSMSResponseStatus *)response __attribute__((swift_name("smsResponse(response:)")));
@end
...
- (id<TruliooCoreIMetadata>)blurFeedbackAutoCaptureDisplayCountCount:(id)count step:(NSString *)step __attribute__((swift_name("blurFeedbackAutoCaptureDisplayCount(count:step:)")));
...
- (id<TruliooCoreIMetadata>)feedbackStateHistoryList:(NSArray<TruliooCoreFeedbackResultThreshold *> *)list __attribute__((swift_name("feedbackStateHistory(list:)")));
...
- (id<TruliooCoreIMetadata>)postCaptureFeedbackErrorUIDisplayedName:(NSString *)name __attribute__((swift_name("postCaptureFeedbackErrorUIDisplayed(name:)")));
- (id<TruliooCoreIMetadata>)postCaptureFeedbackResponseResponse:(TruliooCoreDocumentVerifyResponse *)response __attribute__((swift_name("postCaptureFeedbackResponse(response:)")));
- (id<TruliooCoreIMetadata>)postCaptureFeedbackRetryCountCount:(int32_t)count __attribute__((swift_name("postCaptureFeedbackRetryCount(count:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DoneScreenMetadata")))
@interface TruliooCoreDoneScreenMetadata : TruliooCoreBase <TruliooCoreIMetadataBuilder>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)doneScreenMetadata __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreDoneScreenMetadata *shared __attribute__((swift_name("shared")));
- (id<TruliooCoreIMetadata>)autoContinueOccurredOccurred:(BOOL)occurred __attribute__((swift_name("autoContinueOccurred(occurred:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SMSResponseStatus")))
@interface TruliooCoreSMSResponseStatus : TruliooCoreKotlinEnum<TruliooCoreSMSResponseStatus *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) TruliooCoreSMSResponseStatusCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) TruliooCoreSMSResponseStatus *success __attribute__((swift_name("success")));
@property (class, readonly) TruliooCoreSMSResponseStatus *noMoreRetries __attribute__((swift_name("noMoreRetries")));
@property (class, readonly) TruliooCoreSMSResponseStatus *unknown __attribute__((swift_name("unknown")));
@property (class, readonly) TruliooCoreSMSResponseStatus *invalidFormat __attribute__((swift_name("invalidFormat")));
@property (class, readonly) TruliooCoreSMSResponseStatus *invalidCountry __attribute__((swift_name("invalidCountry")));
@property (class, readonly) TruliooCoreSMSResponseStatus *invalidType __attribute__((swift_name("invalidType")));
@property (class, readonly) TruliooCoreSMSResponseStatus *cannotSend __attribute__((swift_name("cannotSend")));
@property (class, readonly) TruliooCoreSMSResponseStatus *unknownInternalError __attribute__((swift_name("unknownInternalError")));
+ (TruliooCoreKotlinArray<TruliooCoreSMSResponseStatus *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreSMSResponseStatus *> *entries __attribute__((swift_name("entries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SMSResponseStatus.Companion")))
@interface TruliooCoreSMSResponseStatusCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreSMSResponseStatusCompanion *shared __attribute__((swift_name("shared")));
- (TruliooCoreSMSResponseStatus *)fromNameName:(NSString *)name __attribute__((swift_name("fromName(name:)")));
@end
...
- (id<TruliooCoreIMetadata>)uploadSuccessOfTypeType:(TruliooCoreAPIContractStepType *)type __attribute__((swift_name("uploadSuccessOfType(type:)")));
@end
...
__attribute__((swift_name("INetworkPollable")))
@protocol TruliooCoreINetworkPollable
@required
- (void)start_ __attribute__((swift_name("start_()")));
...
- (void)allImagesUploadedOnPollStart:(void (^)(void))onPollStart onComplete:(void (^)(void))onComplete __attribute__((swift_name("allImagesUploaded(onPollStart:onComplete:)")));
- (void)singleImageUploadedType:(TruliooCoreAPIContractStepType *)type onComplete:(void (^)(void))onComplete onError:(void (^)(void))onError __attribute__((swift_name("singleImageUploaded(type:onComplete:onError:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NetworkPollable")))
@interface TruliooCoreNetworkPollable : TruliooCoreBase <TruliooCoreINetworkPollable>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) TruliooCoreNetworkPollableCompanion *companion __attribute__((swift_name("companion")));
- (void)start_ __attribute__((swift_name("start_()")));
- (void)stop __attribute__((swift_name("stop()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NetworkPollable.Companion")))
@interface TruliooCoreNetworkPollableCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreNetworkPollableCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) TruliooCoreSeconds *POLL_DELAY __attribute__((swift_name("POLL_DELAY")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImagePollableDataSource")))
@interface TruliooCoreImagePollableDataSource : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)imagePollableDataSource __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreImagePollableDataSource *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImagePollableDataSource.AllUploadsComplete")))
@interface TruliooCoreImagePollableDataSourceAllUploadsComplete : TruliooCoreBase <TruliooCoreIDataSource>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)allUploadsComplete __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreImagePollableDataSourceAllUploadsComplete *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImagePollableDataSource.SingleUploadComplete")))
@interface TruliooCoreImagePollableDataSourceSingleUploadComplete : TruliooCoreBase <TruliooCoreIDataSource>
- (instancetype)initWithType:(TruliooCoreAPIContractStepType *)type __attribute__((swift_name("init(type:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DetectionFeedback")))
@interface TruliooCoreDetectionFeedback : TruliooCoreBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)sendDocumentImageForFeedbackImage:(id<TruliooCoreIImageParcel>)image completionHandler:(void (^)(id<TruliooCoreKotlinx_coroutines_coreFlow> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("sendDocumentImageForFeedback(image:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)sendImageForVerifyResponseImage:(id<TruliooCoreIImageParcel>)image completionHandler:(void (^)(id<TruliooCoreKotlinx_coroutines_coreFlow> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("sendImageForVerifyResponse(image:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)sendSelfieImageForFeedbackImage:(id<TruliooCoreIImageParcel>)image completionHandler:(void (^)(id<TruliooCoreKotlinx_coroutines_coreFlow> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("sendSelfieImageForFeedback(image:completionHandler:)")));
@end
...
- (void)onIdentifiedImage:(id<TruliooCoreIImageParcel>)image __attribute__((swift_name("onIdentified(image:)")));
...
@property (readonly) TruliooCoreImageRecognizer<id<TruliooCoreImageRecognizerType>> *recognizer __attribute__((swift_name("recognizer")));
@end
...
@interface TruliooCoreUUID : TruliooCoreBase <TruliooCoreKotlinComparable>
- (instancetype)initWithUuid:(NSString *)uuid __attribute__((swift_name("init(uuid:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithVersionNumber:(int32_t)versionNumber timeStamp:(int64_t)timeStamp clockSequence:(int32_t)clockSequence node:(int64_t)node variant:(int32_t)variant __attribute__((swift_name("init(versionNumber:timeStamp:clockSequence:node:variant:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithVersion:(TruliooCoreUUIDVersion *)version timeStamp:(int64_t)timeStamp clockSequence:(int32_t)clockSequence node:(int64_t)node variant:(int32_t)variant __attribute__((swift_name("init(version:timeStamp:clockSequence:node:variant:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) TruliooCoreUUIDCompanion *companion __attribute__((swift_name("companion")));
- (int32_t)compareToOther:(TruliooCoreUUID *)other __attribute__((swift_name("compareTo(other:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
- (NSString *)toStringIncludeBrackets:(BOOL)includeBrackets __attribute__((swift_name("toString(includeBrackets:)")));
@property (readonly) int32_t clockSequence __attribute__((swift_name("clockSequence")));
@property (readonly) BOOL isRfcVariant __attribute__((swift_name("isRfcVariant")));
@property (readonly) int64_t node __attribute__((swift_name("node")));
@property (readonly) int64_t timeStamp __attribute__((swift_name("timeStamp")));
@property (readonly) int32_t variant __attribute__((swift_name("variant")));
@property (readonly) TruliooCoreUUIDVersion * _Nullable version __attribute__((swift_name("version")));
@property (readonly) int32_t versionNumber __attribute__((swift_name("versionNumber")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UUID.Companion")))
@interface TruliooCoreUUIDCompanion : TruliooCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreUUIDCompanion *shared __attribute__((swift_name("shared")));
- (BOOL)isValidUUIDStringSpec:(NSString *)spec __attribute__((swift_name("isValidUUIDString(spec:)")));
@property (readonly) TruliooCoreUUID *NIL __attribute__((swift_name("NIL")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UUID.Version")))
@interface TruliooCoreUUIDVersion : TruliooCoreKotlinEnum<TruliooCoreUUIDVersion *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) TruliooCoreUUIDVersion *timeBased __attribute__((swift_name("timeBased")));
@property (class, readonly) TruliooCoreUUIDVersion *dceSecurity __attribute__((swift_name("dceSecurity")));
@property (class, readonly) TruliooCoreUUIDVersion *nameBasedMd5 __attribute__((swift_name("nameBasedMd5")));
@property (class, readonly) TruliooCoreUUIDVersion *randomBased __attribute__((swift_name("randomBased")));
@property (class, readonly) TruliooCoreUUIDVersion *nameBasedSha1 __attribute__((swift_name("nameBasedSha1")));
+ (TruliooCoreKotlinArray<TruliooCoreUUIDVersion *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TruliooCoreUUIDVersion *> *entries __attribute__((swift_name("entries")));
@end
...
@interface TruliooCoreUUIDCompanion (Extensions)
- (TruliooCoreUUID *)generateUUIDRandom:(TruliooCoreKotlinRandom *)random __attribute__((swift_name("generateUUID(random:)")));
...
@interface TruliooCoreKotlinRandom : TruliooCoreBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) TruliooCoreKotlinRandomDefault *companion __attribute__((swift_name("companion")));
...
- (TruliooCoreKotlinByteArray *)nextBytesArray:(TruliooCoreKotlinByteArray *)array __attribute__((swift_name("nextBytes(array:)")));
- (TruliooCoreKotlinByteArray *)nextBytesArray:(TruliooCoreKotlinByteArray *)array fromIndex:(int32_t)fromIndex toIndex:(int32_t)toIndex __attribute__((swift_name("nextBytes(array:fromIndex:toIndex:)")));
- (TruliooCoreKotlinByteArray *)nextBytesSize:(int32_t)size __attribute__((swift_name("nextBytes(size:)")));
...
@interface TruliooCoreKotlinRandom (Extensions)
- (TruliooCoreUUID *)nextUUID __attribute__((swift_name("nextUUID()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RunSafeKt")))
@interface TruliooCoreRunSafeKt : TruliooCoreBase
+ (id _Nullable)runSafeOperation:(NSString *)operation action:(id _Nullable (^)(void))action __attribute__((swift_name("runSafe(operation:action:)")));
@end
...
- (BOOL)start__ __attribute__((swift_name("start__()")));
...
@interface TruliooCoreKotlinRandomDefault : TruliooCoreKotlinRandom
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)default_ __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TruliooCoreKotlinRandomDefault *shared __attribute__((swift_name("shared")));
- (int32_t)nextBitsBitCount:(int32_t)bitCount __attribute__((swift_name("nextBits(bitCount:)")));
- (BOOL)nextBoolean __attribute__((swift_name("nextBoolean()")));
- (TruliooCoreKotlinByteArray *)nextBytesArray:(TruliooCoreKotlinByteArray *)array __attribute__((swift_name("nextBytes(array:)")));
- (TruliooCoreKotlinByteArray *)nextBytesArray:(TruliooCoreKotlinByteArray *)array fromIndex:(int32_t)fromIndex toIndex:(int32_t)toIndex __attribute__((swift_name("nextBytes(array:fromIndex:toIndex:)")));
...
@property (readonly, getter=start___) id start __attribute__((swift_name("start")));
@end
...
@property (readonly, getter=start___) TruliooCoreInt *start __attribute__((swift_name("start")));
@end
